...
public class MapGUI extends InvGUI {
    ...
    private final ItemStack randomMapIS = new ItemFactory(SkullFactory.buildFromBase64(Heads.RANDOM)).setName("&eMap aléatoire").build();
    ...
    public static int computeInvSize(List<MapData> mapDataList) {
