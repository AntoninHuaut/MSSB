...
public class KBMode extends GameType {
    ...
    private final List<DamageCause> entityIgnore = List.of(DamageCause.ENTITY_ATTACK, DamageCause.ENTITY_EXPLOSION, DamageCause.ENTITY_SWEEP_ATTACK);
    ...
    private void setKBPlayer(Player victim, double finalDamage) {
        double damageGet = finalDamage * getKbMultiplier();
