...
public class StartRun implements Runnable {
    ...
    public void run() {
        ...
        Bukkit.getOnlinePlayers().forEach(p -> p.playSound(p.getLocation(), Sound.ENTITY_EXPERIENCE_ORB_PICKUP, 0.3F, (0.7F + (0.3F * iteration))));
    ...
    private void initStart() {
        EntityManager.getInstance().getPlayableEntityList(gameData).forEach(PlayableEntity::initEntity);
